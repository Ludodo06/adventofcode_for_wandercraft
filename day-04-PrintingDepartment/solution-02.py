...
def get_accessible_paper_rolls_iter(
    source: str,
    nb_surrounding: int = 3
) -> int:
    """
    ...
    Once a paper roll is found to be accessible, we remove it from the grid and
    continue searching for other accessible rolls until no more can be found.
    """
...
if __name__ == "__main__":
    filename = "input.txt"
    print(get_accessible_paper_rolls_iter(filename))
